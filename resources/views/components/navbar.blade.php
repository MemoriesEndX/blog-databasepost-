 ...
 <nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <div x-show=isOpen id="mobile-menu" class="md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <x-navlink href="/" :active="request()->is('/')">Home</x-navlink>
        <x-navlink href="/posts" :active="request()->is('/')">BLog</x-navlink>
        <x-navlink href="/about" :active="request()->is('/')">About</x-navlink>
        <x-navlink href="/contact" :active="request()->is('/')">Contact</x-navlink>
